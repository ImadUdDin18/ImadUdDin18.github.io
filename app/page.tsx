...
export default function Page() {
  ...
  return <main className={dark ? 'site' : 'site light'}>
    ...
    <section className="hero" id="home"><div className="hero-art top-profile"><div className="orbit orbit-one"/><div className="orbit orbit-two"/><div className="profile"><img src="https://github.com/ImadUdDin18.png?size=600" alt="Imad Ud Din GitHub profile"/><span>IMADUDDIN18 · GITHUB</span></div><div className="badge secure"><b>OPEN TO LEARN</b><small>Cloud-first mindset</small></div></div><div className="hero-copy"><span className="pill">AWS · DEVOPS · CI/CD · CLOUD AUTOMATION</span><h1>Hi, I&apos;m <b>Imad Ud Din</b></h1><h3>I&apos;m a <strong key={role} className="role-swap">{roles[role]}</strong></h3><p>I design reliable cloud workflows, automate infrastructure, and build production-minded software. My public work is focused on AWS, Docker, Terraform, Kubernetes, Linux, and CI/CD.</p><div className="buttons"><a href="#projects" className="primary">Explore My Work →</a><a href="https://github.com/ImadUdDin18" target="_blank" rel="noreferrer" className="outline">Visit GitHub ↗</a><a href="/resume.html" download="Imad-Ud-Din-Resume.html" className="resume-button">Download Resume ↓</a><a href="#contact" className="outline">Contact Me</a></div><div className="checks"><span>✓ AWS infrastructure</span><span>✓ DevOps automation</span><span>✓ Open source projects</span></div></div><div className="hero-art hero-details"><div className="badge performance"><b>AWS / DEVOPS</b><small>Building reliable systems</small></div><div className="code"><div><i/><i/><i/><span>deployment.yml</span></div><pre>{`name: imad-cloud
...
status: shipping`}</pre></div></div></section>
    ...
    <footer><a className="logo" href="#home"><span>ID</span><small>IMAD UD DIN</small></a><div><h4>Quick Links</h4><a href="#about">About</a><a href="#projects">Projects</a><a href="#skills">Skills</a></div><div><h4>Connect</h4><a href="https://github.com/ImadUdDin18">GitHub</a><a href="mailto:iamimaduddin20@gmail.com">Email</a></div></footer>
  </main>
}
