...
export default function Page() {
  ...
  const roles = ['Trainee DevOps Engineer', 'AWS Cloud Practitioner', 'Automation Builder']
...
status: shipping`}</pre></div></div></section>
    <section className="intro section" id="about"><div><span className="label">ABOUT ME</span><h2>Engineering Systems That <b>Keep Moving.</b></h2></div><div><p>I&apos;m Imad Ud Din, a Trainee DevOps Engineer from Pakistan. I work with cloud infrastructure, automation, containers, and software projects that turn repeatable processes into dependable delivery.</p><a className="textlink" href="https://github.com/ImadUdDin18" target="_blank" rel="noreferrer">View Imad&apos;s GitHub →</a></div></section>
    ...
    <section className="cta section" id="contact"><span className="label">LET&apos;S CONNECT</span><h2>Let&apos;s Build Something <b>Reliable Together.</b></h2><p>Have a cloud project, automation challenge, or collaboration idea? Reach out.</p><div className="contact-grid"><a href="https://github.com/ImadUdDin18" target="_blank" rel="noreferrer"><small>GitHub</small><b>ImadUdDin18</b></a><a href="mailto:imaduddin@example.com"><small>Email</small><b>imaduddin@example.com</b></a><div><small>Location</small><b>Pakistan</b></div></div><form onSubmit={(event) => event.preventDefault()}><input required placeholder="Name"/><input required type="email" placeholder="Email"/><input required placeholder="Subject"/><textarea required placeholder="Message" rows={5}/><button className="primary">Send Message →</button></form></section>
